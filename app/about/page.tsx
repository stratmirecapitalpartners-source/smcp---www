                    ...
                    <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div className="border border-slate-200 rounded-2xl p-8 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-shadow bg-white">
                                ...
                                <h3 className="text-xl font-bold text-slate-900 mb-3">Extensive Lending Network</h3>
                                <p className="text-slate-600 text-sm leading-relaxed">
                                    Gain access to a nationwide network of over 500 lending partners, including banks,
                                    private lenders, credit unions, institutional lenders, and specialty finance companies.
                                    This allows us to find solutions that traditional lenders often cannot provide.
                                </p>
                            </div>
                            <div className="border border-slate-200 rounded-2xl p-8 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-shadow bg-white">
                                <div className="w-16 h-16 bg-secondary/90 rounded-2xl flex items-center justify-center mb-6 shadow-inner">
                                ...
                                <h3 className="text-xl font-bold text-slate-900 mb-3">Fast and Efficient Process</h3>
                                <p className="text-slate-600 text-sm leading-relaxed">
                                    Our streamlined process helps borrowers move from application to funding quickly. We
                                    work directly with lenders and underwriters to minimize delays and maximize
                                    opportunities.
                                </p>
                            </div>
                            <div className="border border-slate-200 rounded-2xl p-8 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-shadow bg-white">
                                ...
                                <h3 className="text-xl font-bold text-slate-900 mb-3">Customized Financing Strategies</h3>
                                <p className="text-slate-600 text-sm leading-relaxed">
                                    No two borrowers are the same. Our team evaluates your goals, financial profile, and
                                    timeline to identify financing solutions that align with your specific objectives.
                                </p>
                            </div>
                            <div className="border border-slate-200 rounded-2xl p-8 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-shadow bg-white">
                                <div className="w-16 h-16 bg-secondary/90 rounded-2xl flex items-center justify-center mb-6 shadow-inner">
                                ...
                                <h3 className="text-xl font-bold text-slate-900 mb-3">Solutions for Investors and Business Owners</h3>
                                <p className="text-slate-600 text-sm leading-relaxed">
                                    Whether you&apos;re purchasing investment property, expanding operations, acquiring
                                    equipment, or scaling your business, we help structure financing solutions designed to
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            <div>
                                ...
                                <p className="text-lg text-gray-900 mb-10 max-w-md">
                                    Schedule a Consultation or Submit Your Scenario Securely to discover the
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <button
                                        ...
                                        className="bg-primary backdrop-blur-md text-white border border-primary px-8 py-4 rounded-md font-bold text-lg hover:bg-white hover:text-primary transition-all"
                                    >
